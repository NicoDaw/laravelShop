    ...
    <div>
        @foreach ($objetoProducto as $producto)
            <div
                ...
                <div style="margin: 5px; width: 700px">{{ $producto->descripcion }}</div>
                ...
                <a href="/editarProductosPage/{{ $producto->id }}"
                    style=" display: flex; justify-content: center; width: 150px; text-decoration: none">
                    <p
                        style="padding: 10px; border-radius: 10px; background-color: rgb(183, 183, 183); border: 1px solid black; colo: blue">
                        Editar</p>
                </a>
